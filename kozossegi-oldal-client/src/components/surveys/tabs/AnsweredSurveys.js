...
export default function AnsweredSurveys(props) {
                    ...
                    <Container>
                        {
                            props.surveys.length > 0 ?
                                ...
                                : <Typography variant="h6" style={{ textAlign: 'center' }}>Nincsenek kitöltött kérdőívek!</Typography>
                        }
...
// Kérdőív adatait tartalmazó lenyíló lista elem
function SurveyAccordion(props) {
    ...
    const onGoToAnsweredSurvey = () => {
        history.push("/survey/answers/"+survey.id);
    }
    ...
    return (
        <Accordion>
            ...
            <AccordionActions>
                <Button onClick={onGoToAnsweredSurvey} size="small" variant="text">Megnézem</Button>
            </AccordionActions>
        </Accordion>
    )
}
